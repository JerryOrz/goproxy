...
[Click to download Android-SDK](https://github.com/willgeek/goproxy-sdk-android/releases)  
...
[Click to download IOS-SDK](https://github.com/willgeek/goproxy-sdk-ios/releases)  
...
[Click to download Windows-SDK](https://github.com/willgeek/goproxy-sdk-windows/releases)  
...
[Click to download Linux-SDK](https://github.com/willgeek/goproxy-sdk-linux/releases)  
...
[Click to download MacOS-SDK](https://github.com/willgeek/goproxy-sdk-mac/releases)  
...
The specific usage and parameters of these services can be found in [proxy manual](https://github.com/willgeek/goproxy/blob/master/README.md) the SDK service does not support the manual inside: -- daemon and -- forever parameters.
